...
class DefaultAudioVideoController {
    ...
    get isConnecting() {
        ...
        return this.sessionStateController.state() === SessionStateControllerState_1.default.Connecting;
    }
    ...
    get isUpdating() {
        // the sessionStateController keeps track of what we're in the process of doing
        // Use it to check if we're connecting.
        return this.sessionStateController.state() === SessionStateControllerState_1.default.Updating;
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.enableSimulcast) {
                ...
                if (!this.meetingSessionContext.videoUplinkBandwidthPolicy) {
                    this.meetingSessionContext.videoUplinkBandwidthPolicy = new NScaleVideoUplinkBandwidthPolicy_1.default(this.configuration.credentials.attendeeId, !this.meetingSessionContext.browserBehavior.disableResolutionScaleDown(), this.meetingSessionContext.logger);
                }
                if (!this.meetingSessionContext.videoDownlinkBandwidthPolicy) {
